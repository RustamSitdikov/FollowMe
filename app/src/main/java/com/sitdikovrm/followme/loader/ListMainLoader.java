package com.sitdikovrm.followme.loader;
...
public class ListMainLoader extends AsyncTaskLoader<List<ListItem>> {

    private static String TAG = "ListMainLoader";
    ...
    public ListMainLoader(Context context, Credentials credentials, String dir) {
        super(context);
        handler = new Handler();
