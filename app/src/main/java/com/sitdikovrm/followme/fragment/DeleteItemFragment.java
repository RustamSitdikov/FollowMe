...
public class DeleteItemFragment extends IODialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setTitle(isCollection ? R.string.delete_folder_title : R.string.delete_file_title);
...
//        workFragment.cancelDownload();
    ...
    public void onComplete() {
        dialog.dismiss();
        Toast.makeText(getActivity(), isCollection ? R.string.delete_folder_done : R.string.delete_file_done, Toast.LENGTH_LONG).show();
