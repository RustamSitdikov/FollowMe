...
public class RenameMoveItemFragment extends IODialogFragment {
    ...
    private static final String MOVE_SRC_PATH = "move.src.path";
    private static final String MOVE_DST_PATH = "move.dst.path";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setTitle(R.string.move_rename_item_title);
        dialog.setMessage(dstPath);
        dialog.setIndeterminate(true);
        dialog.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
        dialog.setButton(ProgressDialog.BUTTON_NEUTRAL, getText(R.string.make_folder_negative_button), new DialogInterface.OnClickListener() {
            @Override
...
//        workFragment.cancelDownload();
    ...
    public void onComplete() {
        dialog.dismiss();
        Toast.makeText(getActivity(), R.string.move_rename_item_done, Toast.LENGTH_LONG).show();
